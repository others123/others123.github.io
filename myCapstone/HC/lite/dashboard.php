...
$chart = "SELECT disease_name, sum(no_of_victims) FROM tb_chart group by disease_name";
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
           ['disease_name', 'no_of_victims'],


            <?php 

          while ($row=$res->fetch_assoc()) {
              echo "['".$row['disease_name']."',".$row['sum(no_of_victims)']."],";
          }
    ...
    <div id="main-wrapper">
        ...
        while ($row = mysqli_fetch_array($query))
        {
            ...
            echo '<tr>
                    ...
                    <td>'.$row['sick_name'].'</td>
                    <td>'.$row['sick_description'].'</td>
                    <td>'.$row['sick_cause'] . '</td>
                    <td>'.$row['sick_effect'] . '</td>
                    <td>'.$row['sick_countermeasures'] . '</td>
