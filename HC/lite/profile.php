                            ...
                            <div class="card-block">
                                <form class="form-horizontal form-material">
                                    <div class="form-group">
                                        <label class="col-md-12" style="color: silver;">Health Center Name : <label class="col-md-12" style="color: gray;"><input type="text" name="Health Center Name" class="col-md-12 value = Tala Health Center></label></label>
                                        <hr>
                                    </div>
                                   <div class="form-group">
                                  ...
                                  <div class="form-group">
                                        ...
                                        <input type="text" name="Health Center Name" class="col-md-12>
                                        <hr>
                                    </div>
                                   <div class="form-group">
